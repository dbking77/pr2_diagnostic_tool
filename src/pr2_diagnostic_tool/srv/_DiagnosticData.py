"""autogenerated by genpy from pr2_diagnostic_tool/DiagnosticDataRequest.msg. Do not edit."""
import sys
...
class DiagnosticDataRequest(genpy.Message):
  ...
  _type = "pr2_diagnostic_tool/DiagnosticDataRequest"
...
"""autogenerated by genpy from pr2_diagnostic_tool/DiagnosticDataResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import pr2_diagnostic_tool.msg

class DiagnosticDataResponse(genpy.Message):
  _md5sum = "e5409cf279c13e58aa9063cc4e66c6d9"
  _type = "pr2_diagnostic_tool/DiagnosticDataResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """pr2_diagnostic_tool/MotorSample[] sample_buffer


================================================================================
MSG: pr2_diagnostic_tool/MotorSample
float64 timestamp
bool enabled
...
"""
  ...
  _slot_types = ['pr2_diagnostic_tool/MotorSample[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pr2_diagnostic_tool.msg.MotorSample()
        _x = val1
        start = end
        end += 73
...
class DiagnosticData(object):
  _type          = 'pr2_diagnostic_tool/DiagnosticData'
  _md5sum = 'e5409cf279c13e58aa9063cc4e66c6d9'
